...
public class SwaggerConfiguration {
	...
	public GroupedOpenApi kakaoApi() {
		return GroupedOpenApi.builder().group("ssafy-kakao").pathsToMatch("/kakao/**").build();
	}
	...
	public GroupedOpenApi cartApi() {
		return GroupedOpenApi.builder().group("ssafy-cart").pathsToMatch("/cart/**").build();
	}
	
	@Bean
	public GroupedOpenApi hotplaceApi() {
		return GroupedOpenApi.builder().group("ssafy-hotplace").pathsToMatch("/hotplace/**").build();
	}
