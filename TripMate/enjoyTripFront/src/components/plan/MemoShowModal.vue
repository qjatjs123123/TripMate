...
const { ismemoShowModal, curContent_id } = storeToRefs(planStore);
const { findContentById } = planStore;
const memoData = ref({});


const onChangeActive = () => {
  ismemoShowModal.value = false;
};

watch(ismemoShowModal, () => {
  if (!ismemoShowModal.value) return;
...
<template>
  <div
    ...
    :class="['login-container', { active: ismemoShowModal }]"
  >
